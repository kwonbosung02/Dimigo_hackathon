...
#def return_display_str(display_str_list=()):
...
def draw_bounding_box_on_image(image,
  ...
  for display_str in display_str_list[::-1]:
    ...
    #global get_name_proof

    get_name_proof = display_str_list[0]
    get_name_proof = get_name_proof[:-5]
  

    if get_name_proof == 'person':
      pass

    else :
      
      print(get_name_proof)

      
'''   
    if get_name_proof != 'person':
      if get_name_proof == last or get_name_proof == 'person' :
        cnt +=1
      else :
        cnt == 0
